...
import { prismaCli } from '../lib/prismaCli.js';
...
export default function globalSetup() {
  ...
  execFileSync(process.execPath, [prismaCli(), 'migrate', 'diff', '--from-empty', '--to-schema', 'prisma/schema.prisma', '--script', '--output', sqlFile], {
    cwd: backendDir,
    stdio: 'pipe',
  });
