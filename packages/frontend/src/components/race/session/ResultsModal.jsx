        ...
        <div className="fixed inset-0 bg-black/90 flex items-center justify-center z-50 p-4 overflow-y-auto">
            <div className="bg-gray-800 rounded-xl max-w-2xl w-full border border-gray-700 my-8">
                <div className="p-6 border-b border-gray-700 text-center">
                    ...
                    <h2 className="text-2xl font-bold text-white">{t('resultsModal.title')}</h2>
                ...
                <div className="p-6 max-h-60 overflow-y-auto">
                    <table className="w-full">
                        ...
                        <tr className="text-gray-400 text-xs uppercase">
                            <th className="text-left py-2">{t('resultsModal.colPos')}</th>
                            <th className="text-left py-2">{t('resultsModal.colDriver')}</th>
                            <th className="text-center py-2">{t('resultsModal.colLaps')}</th>
                            <th className="text-right py-2">{t('resultsModal.colBest')}</th>
                        </tr>
                        </thead>
                        ...
                        {leaderboard.map((entry, idx) => (
                            <tr key={idx} className="text-white">
                                ...
                                <td className="py-2">{entry.driver?.name || t('common:unknown')}</td>
                ...
                <div className="p-6 border-t border-gray-700">
                    ...
                    >
                        ...
                        {t('resultsModal.backToFreePractice')}
                    </button>
                </div>
            </div>
        </div>
