...
function UsageBadge({ componentName }) {
  ...
  return (
    <div className="flex flex-wrap gap-1">
      {usage.map(page => (
        <span key={page} className="text-xs bg-green-100 text-green-700 px-2 py-0.5 rounded-full">
          {page}
        </span>
      ))}
    </div>
...
function SectionHeader({ title, description, componentName, code }) {
  return (
    <div className="flex items-start justify-between mb-4">
      ...
      <code className="text-sm bg-gray-100 px-3 py-1 rounded whitespace-nowrap">
        {code}
      </code>
    </div>
  )
  ...
  return (
    <>
      ...
      <section>
        ...
        />
        <div className="bg-white p-6 rounded-lg shadow flex flex-wrap gap-6 items-center">
          <div>
            <p className="text-xs text-gray-500 mb-1">size="sm"</p>
            <LapTime time={5234} size="sm" />
          </div>
          <div>
            <p className="text-xs text-gray-500 mb-1">size="md" (default)</p>
            <LapTime time={5234} size="md" />
          </div>
          <div>
            <p className="text-xs text-gray-500 mb-1">size="lg"</p>
            <LapTime time={5234} size="lg" />
          </div>
          <div>
            <p className="text-xs text-gray-500 mb-1">isBest=true</p>
            <LapTime time={5234} isBest={true} />
          </div>
          <div>
            <p className="text-xs text-gray-500 mb-1">null/invalid</p>
            <LapTime time={null} />
          </div>
        </div>
      </section>
      ...
      <section>
        ...
        />
        <div className="bg-white p-6 rounded-lg shadow flex flex-wrap gap-4 items-center">
          <GapDisplay gap={null} />
          <GapDisplay gap="+0.5s" />
  ...
  return (
    <>
      ...
      <section>
        ...
        />
        <div className="bg-white p-6 rounded-lg shadow flex flex-wrap gap-3">
      ...
      <section>
        ...
        <div className="bg-white rounded-lg shadow overflow-hidden">
          ...
          <div className="flex border-b">
            <button className="flex-1 py-2 text-sm font-medium text-gray-500 hover:text-gray-700 border-b-2 border-transparent">
              <BeakerIcon className="w-4 h-4 inline mr-1" />
              Libre
            </button>
            <button className="flex-1 py-2 text-sm font-medium text-purple-600 border-b-2 border-purple-500">
    ...
    <>
      ...
      <section>
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <p className="mt-2 text-sm text-gray-500">Vue actuelle: {view}</p>
        </div>
      </section>
  ...
  return (
    <>
      ...
      <section>
        ...
        <div className="bg-white p-6 rounded-lg shadow space-y-4">
          <div>
            <p className="text-sm text-gray-500 mb-2">Configuration incomplète (3 manquantes)</p>
            <ConfigStatus
              unconfiguredCount={3}
          ...
          <div>
            <p className="text-sm text-gray-500 mb-2">Configuration complète</p>
            <ConfigStatus
              unconfiguredCount={0}
              unconfiguredSlots={[]}
              isComplete={true}
      ...
      <div className="bg-orange-50 border border-orange-200 rounded-lg p-6 mb-8">
        ...
        <div className="flex flex-wrap gap-2">
          {unusedComponents.map(name => (
            <span key={name} className="px-3 py-1 bg-orange-100 text-orange-800 rounded-full text-sm font-medium">
              {name}
            </span>
          ))}
        </div>
